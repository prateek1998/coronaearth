      ...
      <section>
        ...
        <div className="observablehq legend" dir="auto">
          <span>
            ...
            >
              <rect x="0" width="1" height="1" fill="#ffffcc"></rect>
              <rect x="1" width="1" height="1" fill="#ffefa5"></rect>
              <rect x="2" width="1" height="1" fill="#fedc7f"></rect>
              <rect x="3" width="1" height="1" fill="#febf5b"></rect>
              <rect x="4" width="1" height="1" fill="#fd9d43"></rect>
              <rect x="5" width="1" height="1" fill="#fc7034"></rect>
              <rect x="6" width="1" height="1" fill="#f23d26"></rect>
